...
public class NurseController {
    ...
    public ResponseEntity<? super GetChargedCutomerResponseDto> getChargedCustomer(
        @PathVariable("nurseId") String nurseId
    ) {
        ResponseEntity<? super GetChargedCutomerResponseDto> response = nurseService.getChargedCustomer(nurseId);
        return response;
    }
